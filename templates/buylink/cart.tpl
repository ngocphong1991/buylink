    ...
    <form action="" method="post" class="form-horizontal" id="frmCheckOut">
      ...
      <div class="row">
	    <form action="" method="post" id="frmUpdate">
			...
			{if $msg != ''}<p class="error"><span>{$msg}</span></p>{/if}
                        ...
                        <tr>
                            ...
                            <td width="65%">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-7">
                                        <a onclick="$('#FormPromote').submit(); return false;" href="{$_config.www}/cart/" style="margin-right: 10px;" class="button red">Submit</a>
                                    </div>
                                  </div>
                            </td>
                        </tr>
