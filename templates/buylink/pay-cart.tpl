...
<!--
<div class="method pkg">
    <img src="http://advertiser.ad360.vn/images/default/pay_phone.jpg" style="float: left; margin-right: 35px;" />
    <div class="method-inner">
    <div class="btn-choose"></div>
    <div class="method-cnt">
        <div id="h4op1">
            <h4 class="title"><input id="check_addfund1" type="radio" style="float: left; margin:5px 5px 0 0;" /><a>Nạp tiền bằng thẻ cào điện thoại</a><img id="img_addfund1" class="img-paytype-select" style="display: none;" src="http://advertiser.ad360.vn/images/default/support_ok.jpg" alt=""></h4>
            <div class="bank-list">
                <ul class="pkg">
                    <li><img src="http://advertiser.ad360.vn/images/default/phone3.jpg"></li>
                    <li><img src="http://advertiser.ad360.vn/images/default/phone2.jpg"></li>
                    <li><img src="http://advertiser.ad360.vn/images/default/phone4.jpg"></li>
                    <li><img src="http://advertiser.ad360.vn/images/default/phone5.jpg"></li>
                </ul>
            </div>
        </div>
        <form action="/" method="post" enctype="multipart/form-data" id="card" style="display: none;">
            <div class="custom-info pkg" id="addfund1" >
                <div class="row pkg">
                    <div class="pleft"><strong class="lb">Loại thẻ </strong> <span class="red"> * </span></div>
                    <div class="pright">
                        <input type="radio" name="cardtype" value="VMS" id="coupon" class="chk" checked="true">
                        <label style="margin-right:10px; font-size:11px; font-weight:bold;" class="" for="coupon"><img src="http://advertiser.ad360.vn/images/default/phone3.jpg"></label>
                        <input type="radio" name="cardtype" value="VNP" id="voucher" class="chk">
                        <label style=" font-size:11px; font-weight:bold;" for="voucher"><img src="http://advertiser.ad360.vn/images/default/phone2.jpg"> </label>
                    </div>
                </div>
                <div class="row pkg">
                    <div class="pleft"><strong class="lb">Mã thẻ cào </strong> <span class="red"> * </span></div>
                    <div class="pright">
                        <input type="text" class="txt2" style="width:255px;" id="card_code_card" name="pm_card_code" />
                    </div>
                </div>
         
                <hr class="line" />
                <div class="row pkg">
                        <div class="pleft"><strong class="lb">Mã coupon</strong></div>
                        <div class="pright">
                            <input type="text" class="txt2" style="width:255px;" id="card_code_coupon" name="pm_code" /> 
                        </div>
                </div>
                <div class="row">
                    
                    <div class="pright" style="margin-left:160px;">
                    <input type="button" value="Tiếp tục" class="btn normal-btn" onclick="return ajaxCard('card');" name="continue">
                    <img class="btn" name="loading" src="http://advertiser.ad360.vn/images/default/extend/ajax-loader.gif" alt="Loadding" style="display: none;">
                    <input type="reset" class="btn normal-btn grey-btn" value="Đóng" onclick="tb_remove()" />
                    </div>
                </div>
            </div>
         </form>
         <div id="success_card"></div>
         <div id="nav_addfund1" style="float: right; display: none;"><input type="button" value="Tiếp tục" class="btn con-btn"></div>
    </div>
    </div>
</div><!--method-->
            <div class="method pkg">
...
<!--
<div class="method pkg" style="border-bottom:0 none;">
     <img src="http://advertiser.ad360.vn/images/default/pay_tructiep.jpg" style="float: left; margin-right: 30px;" />
    <div class="method-inner">
        <div class="btn-choose"></div>
        <div class="method-cnt">
            <div id="h4op4" >
                <h4 class="title" ><input id="check_addfund4" type="radio" style="float: left; margin:5px 5px 0 0;" /><a>Thanh toán tiền trực tiếp tận nơi <span class="red">Tính phí</span></a><img id="img_addfund4" class="img-paytype-select" style="display: none;" src="http://advertiser.ad360.vn/images/default/support_ok.jpg" alt=""></h4>
                <p class="sub-title">Trong thời gian từ 2-7 ngày làm việc, nhân viên TextLink sẽ đến tận nơi thu tiền của Quý khách. </p>
            </div>
            
            <div id="addfund4" style="display: none;">
                <h4 class="sub-title">Quý khách vui lòng điền thông tin cá nhân: </h4>
                <form method="post" action="/" enctype="multipart/form-data" id="truc-tiep" name="test">
                <table>
                    <tbody>
                        <tr>
                            <td width="50%">
                                <p><strong class="lb">Họ và tên</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:200px;" class="txt2" name="pm_name" id="direct_name"></p>
                            </td>
                            <td width="50%">
                                <p><strong class="lb">Địa chỉ</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:255px;" class="txt2" name="pm_address" id="direct_address"></p>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                                <p><strong class="lb">Email</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:200px;" class="txt2" name="pm_email" id="direct_email"></p>
                            </td>
                            <td width="50%">
                                <div style="width:135px;" class="left">
                                <p><strong class="lb">Quận/Huyện</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:120px;" class="txt2" name="pm_district" id="direct_district"></p>
                                </div>
                                <div style="width:135px;" class="left">
                                <p><strong class="lb">Tỉnh/Thành phố</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:120px;" class="txt2" name="pm_city" id="direct_city"></p>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td width="50%">
                                <p><strong class="lb">Số điện thoại</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:200px;" class="txt2" name="pm_phone" id="direct_phone"></p>
                            </td>
                            <td width="50%">
                                <p><strong class="lb">Thời gian thu tiền thuận tiện nhất cho bạn</strong><span class="red"> * </span></p>
                                <p><input type="text" style="width:255px;" class="txt2" name="pm_time" id="direct_time"></p>
                            </td>
                        </tr>
                       <tr>
                           <td colspan="2">                                 
                                 <div class="row">
                                     ...
                                     <div style="margin-left:160px;" class="pright">
                                        <input type="hidden" name="pm_type" value="tructiep">
                                        <input type="hidden" name="act" value="addFundProcess"> 
                                        <input type="button" value="Tiếp tục" class="btn normal-btn" name="tructipe_continue" id="btnsub_pay_direct" />
                                        <img id="load_pay_direct" class="btn" name="tructiep_loading" src="http://advertiser.ad360.vn/images/default/extend/ajax-loader.gif"  alt="Loadding" style="display: none;">
                                        <input type="reset" value="Bỏ qua" class="btn normal-btn grey-btn" onclick="tb_remove();">
                                    </div>
                                 </div>
                           </td>
                       </tr>
            ...
            <div id="nav_addfund4" style="float: right; display: none;">
                <input type="button" value="Tiếp tục" class="btn con-btn">
            </div>
            <div id="hiddenModalContent_tructiep" style="display:none">
                <div id="report_tructiep"></div>
                <p style="text-align:center"><input type="button" class="btn normal-btn" value="Okie" onclick="tb_remove()" /></p>
            </div>
