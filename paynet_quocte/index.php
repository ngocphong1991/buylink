    ...
    <center>
        <table class="background-image" summary="Meeting Results">
            ...
            <tr>
                ...
                <td><input type="text" name="vpc_Merchant" value="TESTONEPAYUSD" size="20"
                           maxlength="16"/></td>
            ...
            <tr>
                ...
                <td><input type="text" name="vpc_AccessCode" value="2F668CD2"
            ...
            <tr>
                ...
                <td><input type="text" name="vpc_Amount" value="100" size="20"
                           maxlength="10"/></td>
                <td>Số tiền cần thanh toán,Đã được nhân với 100. VD: 100=1USD</td>
                <td>Amount,Multiplied with 100, Ex: 100=1USD</td>
            </tr>
            <tr>
                <td><strong><em>Receipt ReturnURL</em></strong></td>
                <td><input type="text" name="vpc_ReturnURL" size="45"
                           value="http://pay.net.vn/paynet_quocte/dr.php"
                           maxlength="250"/></td>
