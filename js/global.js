...
{
	new Ajax.Request("ajax/marketplace.ajax.php", {

		onSuccess : function(resp) {
			var data = resp.responseText.evalJSON();
			btn.parentNode.parentNode.className = 'bought';
			btn.parentNode.innerHTML = '<a href="#" onclick="removeFromCartMarketplace(this, \''+type+'\', \''+data.id+'\', \''+id+'\', \''+text+'\', \''+url+'\', \''+snippet+'\'); return false;"><img style="padding-bottom: 4px;" src="'+base_url+'/templates/textlink/images/btn-trash.png" alt="Remove" /></a>';
			updateCartLabels();
