<?php /* Smarty version 2.6.18, created on 2014-04-19 07:34:37
...
/images/ad.png">
                ...
                <div class="right-inner">
                    <?php if ($this->_tpl_vars['page'] == ''): ?>
                        ...
                        <?php if (isset ( $this->_tpl_vars['msg_profile'] )): ?><div class="message-error"><?php echo $this->_tpl_vars['msg_profile']; ?>
</div><?php endif; ?>
                        <!--Start panel-->
                                            ...
                                            <fieldset>
                                                <div class="control-group">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8" id="username" readonly name="username" value="<?php echo $this->_tpl_vars['myProfile']['username']; ?>
" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8" id="email" readonly name="email" value="<?php echo $this->_tpl_vars['myProfile']['email']; ?>
" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" id="fullname" name="data[fullname]" value="<?php echo $this->_tpl_vars['myProfile']['fullname']; ?>
" class="col-sm-4 required">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8" id="cmnd" name="data[cmnd]" value="<?php echo $this->_tpl_vars['myProfile']['cmnd']; ?>
" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="file" class="col-sm-8" id="avatar" name="avatar" value="<?php echo $this->_tpl_vars['myProfile']['avatar']; ?>
" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8" value="<?php echo $this->_tpl_vars['myProfile']['tax_code']; ?>
" id="tax_code" name="data[tax_code]" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label" for="address_cmnd">Địa chỉ thường trú (trên CMND) <span class="error">(nếu có)</span> </label>
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8" value="<?php echo $this->_tpl_vars['myProfile']['address_cmnd']; ?>
" id="address_cmnd" name="data[address_cmnd]" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
...
" <?php if ($this->_tpl_vars['myProfile']['gender'] == $this->_tpl_vars['k']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['v']; ?>
</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8" value="<?php echo $this->_tpl_vars['myProfile']['phone']; ?>
" id="phone" name="data[phone]" />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-4 required" id="city" value="<?php echo $this->_tpl_vars['myProfile']['city']; ?>
" name="data[city]" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" class="col-sm-8 required" value="<?php echo $this->_tpl_vars['myProfile']['address']; ?>
" id="address" name="data[address]" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <fieldset>
                                <div class="control-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" readonly class="col-sm-8" value="<?php echo $this->_tpl_vars['pub_money_str']; ?>
" id="data_pub_remain" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" readonly class="col-sm-8" value="<?php echo $this->_tpl_vars['adv_money_str']; ?>
" id="data_adv_remain" />
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    var pub_money = parseInt(<?php echo $this->_tpl_vars['my_profile']['pub_money']; ?>
);
    var adv_money = parseInt(<?php echo $this->_tpl_vars['my_profile']['adv_money']; ?>
);
</script>
<?php echo '
    <script type="text/javascript">
