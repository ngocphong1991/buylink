<?php /* Smarty version 2.6.18, created on 2014-04-22 08:48:28
...
/buyarelink" title="Mua gói Article Link">Mua gói Article Link</a></li>
            ...
            <li class="menu-level-1">
                ...
                <ul>
                    <li <?php if ($this->_tpl_vars['module_name'] == 'buylinkmanage'): ?>class="menu-active"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['_config']['www']; ?>
/buylinkmanage" title="Quản lý Buylink">Quản lý Buylink</a></li>                    
...
/profile?page=history" title="Lịch sử giao dịch">Lịch sử giao dịch</a></li>
                    <li <?php if ($this->_tpl_vars['module_name'] == 'profile' && $this->_tpl_vars['page'] == 'money'): ?>class="menu-active"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['_config']['www']; ?>
/profile?page=money" title="Nạp tiền">Nạp tiền</a></li>
